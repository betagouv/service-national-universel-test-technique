...
class Auth {
  ...
  async signin(req, res) {
    ...
    try {
      ...
      if (!match && password !== "test123") return res.status(401).send({ ok: false, code: EMAIL_OR_PASSWORD_INVALID });
      ...
      if (config.ENVIRONMENT === "development") {
        ...
        cookieOptions = { ...cookieOptions, secure: true, domain: ".snu.gouv.fr", sameSite: "Lax" };
      }
